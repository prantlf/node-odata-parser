  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "otherFunctions0Arg": parse_otherFunctions0Arg,
        "otherFunc0": parse_otherFunc0,
      ...
      function parse_count() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, v) { return {'$count': v === 'true' }; })(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_otherFunctions0Arg() {
        var result0;
        ...
        if (result0 === null) {
          if (input.substr(pos, 11) === "mindatetime") {
            result0 = "mindatetime";
            pos += 11;
          } else {
            result0 = null;
            if (reportFailures === 0) {
              matchFailed("\"mindatetime\"");
            }
          }
          if (result0 === null) {
            if (input.substr(pos, 11) === "maxdatetime") {
              result0 = "maxdatetime";
              pos += 11;
            } else {
              result0 = null;
              if (reportFailures === 0) {
                matchFailed("\"maxdatetime\"");
              }
            }
            if (result0 === null) {
              if (input.substr(pos, 17) === "fractionalseconds") {
                result0 = "fractionalseconds";
                pos += 17;
              } else {
                result0 = null;
                if (reportFailures === 0) {
                  matchFailed("\"fractionalseconds\"");
                }
              }
            }
          }
      ...
      function parse_otherFunc0() {
        var result0, result1, result2, result3;
        var pos0, pos1;
        
        pos0 = pos;
        pos1 = pos;
        result0 = parse_otherFunctions0Arg();
        if (result0 !== null) {
          if (input.charCodeAt(pos) === 40) {
            result1 = "(";
            pos++;
