...
dateTime                    =   "datetime" SQUOTE a:dateTimeBody SQUOTE { return a; }
...
dateTimeBodyB               =  a:dateTimeBodyA ":" b:second "Z"? { a.seconds = b; return a; }
dateTimeBodyC               =  a:dateTimeBodyB "." b:nanoSeconds { a.nanoSeconds = b; return a; }
...
filterExpr                  =
							  "(" WSP? left:filterExpr WSP? ")" right:( WSP type:("and"/"or") WSP value:filterExpr{
...
booleanFunctions2Args       =  "substringof" / "contains" / "endswith" / "startswith" / "IsOf"
